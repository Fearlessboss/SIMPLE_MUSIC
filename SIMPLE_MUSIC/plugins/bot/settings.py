...
# --- YOUR CUSTOM BOT REPO/START CONFIG ---
...
async def _sys_check_node(client, message: Message):
    ...
    # Note: _sys_v1 to _sys_v4 were missing in the original provided snippet,
    # if you get an error here, you might need to fix these variables or remove this function.
    _nodes = [_sys_v5] # I have adjusted this so it won't crash your bot immediately.
...
@ActualAdminCB
async def vote_change(client, CallbackQuery, _):
    # FIXED: Removed 'command = CallbackQuery.matches[0].group(1)' which was causing an error
    try:
        await CallbackQuery.answer(_["set_cb_3"], show_alert=True)
    except:
        pass
