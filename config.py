...
# Naye variables (Agah Heroku pe set na hon, toh default links kaam karenge aur crash nahi hoga)
START_PRIVATE_VIDEO_URL = getenv("START_PRIVATE_VIDEO_URL") or "https://files.catbox.moe/eqvggb.mp4"
START_GROUP_VIDEO_URL = getenv("START_GROUP_VIDEO_URL") or "https://files.catbox.moe/eqvggb.mp4"
HELP_VIDEO_URL = getenv("HELP_VIDEO_URL") or "https://files.catbox.moe/eqvggb.mp4"
WELCOME_VIDEO_URL = getenv("WELCOME_VIDEO_URL") or "https://files.catbox.moe/eqvggb.mp4"
INFO_IMG_URL = getenv("INFO_IMG_URL") or "https://files.catbox.moe/z1h6ow.jpg"

# Purane variables fallback ke liye (Taki heroku agar purana data dhunde toh error na aaye)
START_IMG_URL = getenv("START_IMG_URL") or "https://files.catbox.moe/z1h6ow.jpg"
PING_IMG_URL = getenv("PING_IMG_URL") or "https://files.catbox.moe/z1h6ow.jpg"
HELP_IMG_URL = getenv("HELP_IMG_URL") or "https://img.sanishtech.com/u/aa63cf917e3a4e0c380380ae9f9d08c5.jpg"
